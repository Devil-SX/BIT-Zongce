...
summarize_excel = root_dir / '（2023-2版）2020级表2：北京理工大学信息与电子学院个人及班级综测成绩汇总版.xlsx'
# 以上目录都以成功创建好


# 删除原有文件
if os.path.exists(summarize_excel):
    os.remove(summarize_excel)
